...
async function fetchSheetData() {
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbydMrT_UuI1aZIktW2RbW3EJzrZYRgpIaDfn4sMLaQpUkCf1UvjBLIOPruvPNLmNvRn/exec');
...
function openGoogleSheet() {
    window.open('https://docs.google.com/spreadsheets/d/1e5gYRKcTZyuyrJIhEtdh0PSQoc267ZK_kTiESd_1byo/edit?gid=0#gid=0', '_blank');
}
